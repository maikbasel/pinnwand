  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        className={cn(
          // pointer-events-auto: a Vaul drawer leaves `pointer-events: none`
          // stuck on <body> after a sibling drawer/dialog closes (and its own
          // cleanup lags the close animation). Without this the drawer's
          // content goes inert while its overlay stays interactive for
          // swipe-dismiss, so taps on a row button fall through to the overlay
          // and dismiss the drawer instead of firing.
