...
export const ADD_TASK_SUBMIT = "Hinzufügen";
...
export const TASK_ASSIGNEES_LOAD_ERROR =
  "Mitglieder konnten nicht geladen werden.";
export const TASK_ASSIGNEES_ALL_ASSIGNED = "Alle Mitglieder sind zugewiesen.";
export const TASK_ASSIGNEES_NO_MATCH = "Keine passenden Mitglieder.";
export const ASSIGNEE_SEARCH_PLACEHOLDER = "Mitglied suchen …";
export const ASSIGNEE_REMOVE_LABEL = "Entfernen";
