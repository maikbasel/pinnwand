  ...
  return (
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          className={cn(
            // pointer-events-auto: when this menu opens inside a Vaul drawer
            // (the mobile switcher), Vaul locks <body> with
            // `pointer-events: none` (vaul#245 / radix#1241). The menu is
            // portaled to <body>, so without this it inherits the lock — the
            // items paint but taps fall through to Vaul's overlay and dismiss
            // the drawer instead of firing the action. No-op on desktop.
            "data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:fade-in-0 data-open:zoom-in-95 data-closed:fade-out-0 data-closed:zoom-out-95 pointer-events-auto z-50 max-h-(--available-height) w-(--anchor-width) min-w-32 origin-(--transform-origin) overflow-y-auto overflow-x-hidden rounded-lg bg-popover p-1 text-popover-foreground shadow-md outline-none ring-1 ring-foreground/10 duration-100 data-closed:animate-out data-open:animate-in data-closed:overflow-hidden",
            className
          )}
